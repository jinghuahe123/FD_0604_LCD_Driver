...
const DisplayDriver_FD0604::DisplayMask DisplayDriver_FD0604::number[40] PROGMEM = { // [digit][gnd pin]
...
const DisplayDriver_FD0604::DisplayMask DisplayDriver_FD0604::special_character[4] PROGMEM {
...
const DisplayDriver_FD0604::DisplayMask DisplayDriver_FD0604::letter[24] PROGMEM = {
...
const DisplayDriver_FD0604::DisplayMask DisplayDriver_FD0604::number_upsidedown[40] PROGMEM {
...
const DisplayDriver_FD0604::DisplayMask DisplayDriver_FD0604::letter_upsidedown[24] PROGMEM = {
...
const DisplayDriver_FD0604::DisplayMask DisplayDriver_FD0604::special_character_upsidedown[4] PROGMEM = {
  {0x0001, 0x0000}, // clock region
  {0x0408, 0x2040}, // nullDisplay
...
void DisplayDriver_FD0604::getNumber(uint8_t index, DisplayDriver_FD0604::DisplayMask& output) {
  memcpy_P(&output, &number[index], sizeof(number[index]));
}

void DisplayDriver_FD0604::getNumberUpsideDown(uint8_t index, DisplayDriver_FD0604::DisplayMask& output) {
  memcpy_P(&output, &number_upsidedown[index], sizeof(number_upsidedown[index]));
}


void DisplayDriver_FD0604::getSpecialChar(uint8_t index, DisplayDriver_FD0604::DisplayMask& output) {
  memcpy_P(&output, &special_character[index], sizeof(special_character[index]));
}

void DisplayDriver_FD0604::getSpecialCharUpsideDown(uint8_t index, DisplayDriver_FD0604::DisplayMask& output) {
  memcpy_P(&output, &special_character_upsidedown[index], sizeof(special_character_upsidedown[index]));
}


void DisplayDriver_FD0604::getLetter(uint8_t index, DisplayDriver_FD0604::DisplayMask& output) {
  memcpy_P(&output, &letter[index], sizeof(letter[index]));
}

void DisplayDriver_FD0604::getLetterUpsideDown(uint8_t index, DisplayDriver_FD0604::DisplayMask& output) {
